$(function () {
	GetvisitedProfilesByMe();
	getMyProfileVisitedByOthers();
});
...
GetvisitedProfilesByMe = () => {
	ajaxCall('Account/GetvisitedProfiles', null, function (response) {
		var element = "";
...
getMyProfileVisitedByOthers = () => {
	ajaxCall('Account/getMyProfileVisitedByOthers', null, function (response) {
		var element = "";
		...
		$('#MyProfileVisitedByOthers').empty();
		$('#MyProfileVisitedByOthers').append(element);
	});
}
