$(function () {
	GetFavouriteProfilesByMe();
	GetMyProfileFavouriteByOthers();
});
...
GetFavouriteProfilesByMe = () => {
	ajaxCall('Account/GetMyFavouriteProfiles', null, function (response) {
		var element = "";
		...
		$('#FavouriteProfilesByMe').empty();
		$('#FavouriteProfilesByMe').append(element);
	});
}
...
GetMyProfileFavouriteByOthers = () => {
	ajaxCall('Account/GetMyProfileFavouriteByOthers', null, function (response) {
		var element = "";
