...
<head>
	...
	<!-- daterange picker -->
	<link rel="stylesheet" href="<?php echo base_url('resources/css/admin/daterangepicker.css') ?>">
	<!-- Google Font: Source Sans Pro -->
	<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700">

	<!-- Common -->
	<link rel="stylesheet" href="<?php echo base_url('resources/css/admin/common.css') ?>">
	<!-- Toster message -->
