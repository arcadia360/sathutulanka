<footer class="main-footer">
	...
	<strong>Copyright &copy; 2018-2021 <a href="#">arcadia360.lk</a>.</strong> All rights reserved.
</footer>
...
<!-- Notification  -->
<!-- <script src="<?php echo base_url('resources/js/admin/notification.js') ?>"></script> -->
