            ...
            <div class="card-body">
                <div class="box">
                    <div class="box-body">
                        ...
                        <table id="tblMarkAsPremiumMembers" class="table table-bordered table-striped">
...
<script>
    $(document).ready(function() {
        ...
        $('#tblMarkAsPremiumMembers').DataTable({
            'ajax': 'GetMarkAsPremiumMembers/' + convertToShortDate(monthStartDate) + '/' + convertToShortDate(date),
            'order': [],
            "bDestroy": true
        });
        ...
        $('input[name="daterange"]').daterangepicker({
            ...
            $('#tblMarkAsPremiumMembers').DataTable({
                'ajax': 'GetMarkAsPremiumMembers/' + selectedFromDate + '/' + selectedToDate,
                'order': [],
                "bDestroy": true
            });
        });
