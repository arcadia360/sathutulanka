					...
					<div class="row">
						<div class="col-lg-6 col-sm-6 col-12">
							<div class="form-group">
								...
								<select class="custom-select d-block form-control" id="motherTongue" required>
						...
						<div class="col-lg-6 col-sm-6 col-12">
							<div class="form-group">
								<label class="text-inverse" for="validationCustom02"><?= lang('ethnicity') ?></label>
								<select class="custom-select d-block form-control" id="ethnicity" required>
									<option value="">Open this select menu</option>
									<option value="1">One</option>
									<option value="2">Two</option>
									<option value="3">Three</option>
