...
<div class="container-fluid" style="background-color: white; height:500px;">
    ...
    <div class="col-md-6 offset-md-3 col-sm-12 text-center" style="background-color: white; margin-top: 20px;">
        ...
        <div class="row">
            <div style="margin: 20px auto;">
                <div style="width: 100px; padding-left: 10px; padding-right: 10px; position: relative; float:left;">
                    <input class="form-control form-control-lg text-center only-decimal" type="text" id="no1" name="no1" placeholder="_" maxlength="1">
                </div>
                <div style="width: 100px; padding-left: 10px; padding-right: 10px;  position: relative; float:left;">
                    <input class="form-control form-control-lg text-center only-decimal" type="text" id="no2" name="no2" placeholder="_" maxlength="1">
                </div>
                <div style="width: 100px; padding-left: 10px; padding-right: 10px;  position: relative; float:left;">
                    <input class="form-control form-control-lg text-center only-decimal" type="text" id="no3" name="no3" placeholder="_" maxlength="1">
                </div>
                <div style="width: 100px; padding-left: 10px; padding-right: 10px;  position: relative; float:left;">
                    <input class="form-control form-control-lg text-center only-decimal" type="text" id="no4" name="no4" placeholder="_" maxlength="1">
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <input type="hidden" id="txtCountryCode" name="txtCountryCode" value=<?php echo $vcCountryCode; ?>>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="col-md-12 pt-3">
                    <input type="number" class="form-control form-padding red-color only-decimal" name="mobile_no" id="mobile_no" placeholder="Mobile No">
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#no1').on('keyup', function(e) {
            $("#no2").focus();
        });
        $('#no2').on('keyup', function(e) {
            $("#no3").focus();
        });
        ...
        $("#btnUpdateNumber").click(function() {
            ...
            if (jQuery.trim($("#country_code").val()) == 94 && length != 9) {
    ...
    function editMobileNumer(EmailVerificationCode) {
        var code = jQuery.trim($("#txtCountryCode").val());
