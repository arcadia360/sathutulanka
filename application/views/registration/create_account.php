...
<body>
    ...
    <!-- <div class="container"> -->
    <div class="row">
        <div class="col-lg-8 col-md-7 d-none d-md-block d-lg-block" style="background-color: blue;">
            A
        </div>
        <div class="col-lg-4 col-md-5 col-sm-12" style="background-color: yellow;">
            B
            <form class="ajax-submit" action="http://test.sathutulanka.lk/register" method="post" id="submitForm" autocomplete="off">
                <input type="hidden" name="_token" value="QprnXEt5Y7iU48fAVpK0VqUiea4uSzgk9LyIq5AV">
                <div class="px-3 py-5 home-main-search-bgcolor reg_form">
                    ...
                    <div class="col-md-12 pt-3 form-group">
                        ...
                        <div class="col-md-12">
                            ...
                            <select class="js-example-basic-single dropdown-s2 p20" name="provide_infor" id="provide_infor">
                        ...
                        <div class="col-md-12 pt-4">
                            ...
                            <select class="js-example-basic-single dropdown-s2 p20" name="gender" id="gender">
                                <option value="">Select</option>
                        ...
                        <p class="p20 yellow-color gill-sans-mt-regular-font mb-2 ml-3">Date Of Birth</p>
                        <div class="row mx-0 mr-4">

                            <div class="col-md-4">
                                <select class="js-example-basic-single dropdown-s2 p20" name="birth_day" id="birth_day">
                            ...
                            <div class="col-md-4">
                                <select class="js-example-basic-single dropdown-s2 p20" name="birth_month" id="birth_month">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="js-example-basic-single dropdown-s2 p20" name="birth_year" id="birth_year">
                        ...
                        <div class="col-md-12 pt-4">
                            ...
                            <select class="js-example-basic-single dropdown-s2 p20" name="marital_status" id="marital_status" onchange="getMarryDetails(this)">
                                <option value="">Select</option>
                        ...
                        <div class="col-md-12 pt-4 childrenDiv">
                            ...
                            <select class="js-example-basic-single dropdown-s2 p20" name="num_of_child" id="num_of_child">
                                <option value="">Select</option>
                        ...
                        <div class="col-md-12 pt-2">
                            ...
                            <select class="js-example-basic-single dropdown-s2 p20" name="marry_by" id="marry_by">
                                <option value="">Select</option>
                        ...
                        <div class="col-md-12 text-center pt-3 pb-2">
                            <button type="submit" class="btn btn-primary gill-sans-mt-regular-font home-search-btn p20 home-search-letter-spacing sbmitBtn">&nbsp;CONTINUE&nbsp;</button>
                        </div>
