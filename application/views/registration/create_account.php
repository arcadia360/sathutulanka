                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" name="btnSaveUser" id="btnSaveUser" class="btn" style="background-color: #EA3C53; color:#FFFFFF;">&nbsp;&nbsp;OK&nbsp;&nbsp;</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal fade" id="termsConditionsModal" tabindex="-1" role="dialog" aria-labelledby="termsConditionsModal" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn" data-dismiss="modal" style="background-color: #EA3C53; color:#FFFFFF;">&nbsp;&nbsp;OK&nbsp;&nbsp;</button>
                                </div>
                            </div>
                        </div>
                    </div>
