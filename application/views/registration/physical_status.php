			...
			<div class="offset-lg-2 col-lg-8 col-md-12 col-sm-12 border rounded main-section">
				...
				<div class="row">
					<div class="col-lg-12 col-12">
						<div class="form-group">
							<label class="text-inverse" for="inputEmail4"><?= lang('bodyShape') ?></label> <br>
							<div class="row">
								<div class="col-4 d-flex align-items-center">
									<img class="img-thumbnail margin-0-auto body-size" src="<?= base_url('resources/images/slim.png') ?>" alt="slim image">
									<label class="custom-control custom-radio">
										<input id="radioStacked1" name="bodyShape" type="radio" class="custom-control-input" value="1">
								...
								<div class="col-4 d-flex align-items-center">
									...
									<label class="custom-control custom-radio">
										<input id="radioStacked1" name="bodyShape" type="radio" class="custom-control-input" value="2">
										<span class="custom-control-indicator"></span>
								...
								<div class="col-4 d-flex align-items-center">
									...
									<label class="custom-control custom-radio">
										<input id="radioStacked1" name="bodyShape" type="radio" class="custom-control-input" value="3">
										<span class="custom-control-indicator"></span>
						...
						<div class="form-group">
							...
							<div class="row">
								...
								<div class="col-2">
									...
									<div class="text-al-center">
										<input type="radio" name="skinColor" value="1" id="veryFair">
									</div>
								</div>
								<div class="col-2">
									<div class="text-al-center">
								...
								<div class="col-2">
									...
									<div class="text-al-center">
										<input type="radio" name="skinColor" value="3">
									</div>
								</div>
								<div class="col-2">
									<div class="text-al-center">
									...
									<div class="text-al-center">
										<input type="radio" name="skinColor" value="4">
									</div>
								</div>
								<div class="col-2">
									<div class="text-al-center">
									...
									<div class="text-al-center">
										<input type="radio" name="skinColor" value="5">
									</div>
								</div>
								<div class="col-1"></div>
								<!-- end skin colour -->
								<div class="col-lg-6 col-sm-12 col-12">
									<div class="form-group">
										...
										<select class="custom-select d-block form-control" id="disability" name="disability">
											<option value=""><?= lang('select') ?></option>
								...
								<div class="col-lg-6 col-sm-12 col-12">
									<div class="form-group">
										...
										<select class="custom-select d-block form-control" id="healthInfo" name="healthInfo">
											<option value=""><?= lang('select') ?></option>
