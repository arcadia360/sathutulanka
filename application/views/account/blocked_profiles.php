 ...
 <div class="container p-3">
     <p class="display-5 text-center font-weight-bold">Blocked Profile</p>
     <nav>
         <div class="nav nav-tabs" id="nav-tab" role="tablist">
             <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Profiles Blocked By Me</a>
             <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">My Profile Blocked By Others</a>
         </div>
     </nav>
     <div class="tab-content" id="nav-tabContent">
         <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
             <div class="row" id="FavouriteProfilesByMe">
             </div>
         </div>
         <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
             <div class="row" id="MyProfileFavouriteByOthers">
             </div>
         </div>
     </div>
 </div>
 <script src="<?= base_url("resources/js/pageJS/blockedProfiles.js") ?>"></script>