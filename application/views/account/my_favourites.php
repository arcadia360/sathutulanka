 ...
 <div class="container p-3">
     <p class="display-5 text-center font-weight-bold">My Favourites</p>
     <nav>
         <div class="nav nav-tabs" id="nav-tab" role="tablist">
             <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">By Me</a>
             <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">By Others</a>
         </div>
     </nav>
 ...
 <script src="<?= base_url("resources/js/pageJS/myFavourites.js") ?>"></script>